              ...
              <div className="max-w-screen p-10">
                ...
                <div className="flex justify-center flex-col md:flex-row md:gap-5 xl:gap-20">
                  ...
                  <div className="group-todo w-full xl:w-[25%]">
                    <Link to="/todo" className="btn btn-sm bg-white hover:bg-white"><FaTasks /> Add tasks</Link>
                    <div className="bg-white h-[385px] group overflow-auto shadow mt-5 rounded-lg p-10">
                      <div className="flex items-center justify-between">
                        ...
                        <p className="text-sm font-bold text-red-400/75">{todos.length} tasks</p>
                      </div>
                      {todos.map(todo => (
                        <div key={todo.id} className="task-group p-2 flex justify-between my-4 items-center rounded-full bg-red-300/25 w-full">
                          <p className="font-bold ms-2">{todo.text}</p>
                          <div className="check w-8 h-8 bg-red-300 rounded-full"></div>
                        </div>
                      ))}
                    </div>
                  </div>
